...
1. [Setup - The basics of getting started with apmysql](#setup)
    * [What apmysql affects](#what-apmysql-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with apmysql](#beginning-with-apmysql)
